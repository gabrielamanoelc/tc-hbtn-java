...
public class Program {
    public static void main(String[] args) {
        ...
        Set postsDevOps = blog1.obterPostsPorCategoria(Categorias.DEVOPS);

        System.out.println(postsDevOps);

        Set postsDev = blog1.obterPostsPorCategoria(Categorias.DESENVOLVIMENTO);

        System.out.println(postsDev);

        Set postsData = blog1.obterPostsPorCategoria(Categorias.DATA_SCIENCE);

        System.out.println(postsData);

        Set postsJaneDoe = blog1.obterPostsPorAutor(new Autor("Jane", "Doe"));
